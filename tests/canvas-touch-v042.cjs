...
(async()=>{
 ...
 try{
  ...
  await page.goto('http://127.0.0.1:'+server.address().port);await page.waitForFunction(()=>!!window.touchStable);await page.waitForTimeout(80);await page.evaluate(()=>window.touchStable.start());await page.waitForTimeout(80);
